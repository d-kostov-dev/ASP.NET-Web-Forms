<%@ Page 
    ...
    Inherits="Application.Site.Administration.Countries.AddEdit" %>
            ...
            <div class="panel-body">
                <div class="form-horizontal" id="mangeItemForm" runat="server">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label for="Population" class="col-lg-2 control-label">Population</label>
                            <div class="col-lg-10">
                                <asp:TextBox ID="Population" type="numeric" class="form-control" runat="server" />
                                <asp:RequiredFieldValidator 
                                    runat="server" 
                                    CssClass="text-danger"
                                    ControlToValidate="Population" 
                                    ErrorMessage="The Field Is Required!" 
                                    Display="Dynamic"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="Continent" class="col-lg-2 control-label">Continent</label>
                            <div class="col-lg-10">
                                <asp:DropDownList ID="Continent" class="form-control" runat="server" DataTextField="Name" DataValueField="Id" />
                            </div>
                        </div>
